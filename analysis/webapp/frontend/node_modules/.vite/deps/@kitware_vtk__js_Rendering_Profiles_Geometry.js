...
} from "./chunk-KDGT4RJH.js";
import {
  vtkPolyData$1
} from "./chunk-6BHHZBU2.js";
import {
  vtkPoints$1
} from "./chunk-RM6DVBFB.js";
import {
  Constants,
  PassTypes,
  Resolve,
...
} from "./chunk-ZJDYH57Z.js";
import {
  vtkDataSet$1
} from "./chunk-YFKVQWKX.js";
import "./chunk-WKFNK2HM.js";
import {
  vtkDataArray$1
} from "./chunk-VNVWXTI6.js";
import {
  Representation,
  vtkActor$1,
  vtkProp$1,
  vtkProperty$1
} from "./chunk-VHKSQB2I.js";
import {
  vtkBoundingBox
} from "./chunk-XTGH6FO7.js";
import {
  mat3_exports,
  mat4_exports,
  vec3_exports
} from "./chunk-HV45FELU.js";
import {
  get,
  getArray,
  macro,
...
var newInstance6 = macro.newInstance(extend6, "vtkCubeAxesActor");
...
var newInstance7 = newInstance(extend7, "vtkOpenGLCubeAxesActor");
registerOverride("vtkCubeAxesActor", newInstance7);
...
var newInstance8 = newInstance(extend8, "vtkOpenGLPolyDataMapper");
registerOverride("vtkMapper", newInstance8);
...
var newInstance9 = macro.newInstance(extend9, "vtkMapper2D");
var vtkMapper2D$1 = {
  ...
  publicAPI.setMapperShaderParameters = (cellBO, ren, actor) => {
    ...
    if (cellBO.getProgram().isAttributeUsed("vertexWC")) {
      if (!cellBO.getVAO().addAttributeArray(cellBO.getProgram(), cellBO.getCABO(), "vertexWC", cellBO.getCABO().getVertexOffset(), cellBO.getCABO().getStride(), model.context.FLOAT, 3, false)) {
        vtkErrorMacro2("Error setting vertexWC in shader VAO.");
      }
    }
    if (cellBO.getCABO().getElementCount() && (model.VBOBuildTime.getMTime() > cellBO.getAttributeUpdateTime().getMTime() || cellBO.getShaderSourceTime().getMTime() > cellBO.getAttributeUpdateTime().getMTime())) {
      model.renderable.getCustomShaderAttributes().forEach((attrName, idx) => {
...
var newInstance10 = newInstance(extend10, "vtkOpenGLPolyDataMapper2D");
registerOverride("vtkMapper2D", newInstance10);
...
var newInstance11 = macro.newInstance(extend11, "vtkScalarBarActor");
...
var newInstance12 = newInstance(extend12, "vtkOpenGLScalarBarActor");
registerOverride("vtkScalarBarActor", newInstance12);
  ...
  publicAPI.updateBufferObjects = () => {
    ...
    if (model.renderable.getFormat() !== model.lastFormat) {
      ...
      if (!model.tris.getVAO().addAttributeArray(model.tris.getProgram(), model.tris.getCABO(), "vertexMC", model.tris.getCABO().getVertexOffset(), model.tris.getCABO().getStride(), model.context.FLOAT, 3, model.context.FALSE)) {
        vtkErrorMacro3("Error setting vertexMC in shader VAO.");
      }
    }
    const tmaps = model.renderable.getTextures();
    if (!tmaps.length) {
      vtkErrorMacro3("vtkSkybox requires a texture map");
    }
...
var newInstance13 = newInstance(extend13);
registerOverride("vtkSkybox", newInstance13);
...
var newInstance14 = newInstance(extend14, "vtkOpenGLPixelSpaceCallbackMapper");
registerOverride("vtkPixelSpaceCallbackMapper", newInstance14);
...
var newInstance15 = macro.newInstance(extend15);
...
var newInstance16 = newInstance(extend16, "vtkWebGPURenderer");
registerOverride2("vtkRenderer", newInstance16);
...
registerOverride2("vtkActor", newInstance17);
...
registerOverride2("vtkActor2D", newInstance18);
...
var newInstance19 = newInstance(extend19, "vtkWebGPUCubeAxesActor");
registerOverride2("vtkCubeAxesActor", newInstance19);
...
var newInstance20 = macro.newInstance(extend20, "vtkProperty2D");
var vtkProperty2D$1 = {
...
function extend21(publicAPI, model) {
  ...
  Object.assign(model, DEFAULT_VALUES18, initiaLalues);
...
var newInstance21 = newInstance(extend21, "vtkWebGPUCellArrayMapper");
...
function vtkWebGPUPolyDataMapper(publicAPI, model) {
  ...
  publicAPI.updateCellArrayMappers = (poly) => {
    ...
    const cellMappers = [];
    let cellOffset = 0;
    for (let i = PrimitiveTypes2.Points; i <= PrimitiveTypes2.Triangles; i++) {
    ...
    if (model.WebGPUActor.getRenderable().getProperty().getEdgeVisibility()) {
      for (let i = PrimitiveTypes2.TriangleEdges; i <= PrimitiveTypes2.TriangleStripEdges; i++) {
...
var newInstance22 = newInstance(extend22, "vtkWebGPUPolyDataMapper");
registerOverride2("vtkMapper", newInstance22);
...
var newInstance23 = newInstance(extend23, "vtkWebGPUPolyDataMapper2D");
registerOverride2("vtkMapper2D", newInstance23);
...
var newInstance24 = newInstance(extend24, "vtkWebGPUScalarBarActor");
registerOverride2("vtkScalarBarActor", newInstance24);
...
var newInstance25 = macro.newInstance(extend25, "vtkWebGPUPixelSpaceCallbackMapper");
registerOverride2("vtkPixelSpaceCallbackMapper", newInstance25);
