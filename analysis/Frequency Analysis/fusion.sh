...
#SBATCH --job-name=analysis_graphs_fusion
...
source /scratch/mthakur/manifold/analysis/.venv/bin/activate
cd "/scratch/mthakur/manifold/analysis/Frequency Analysis"
python "/scratch/mthakur/manifold/analysis/Frequency Analysis/Run Fusion All.py"
