...
# _WILOR_COMP_CLIP = "120-2_clip_2_modified"
...
# _WILOR_COMP_CLIP = "120-2_clip_6_modified"
...
# _WILOR_COMP_CLIP = "clip_4_modified"
...
# _MEDIAPIPE_CLIP = "demo1_keypoints.csv"
# _MEDIAPIPE_CLIP = "demo2_keypoints.csv"
# _MEDIAPIPE_CLIP = "demo3_keypoints.csv"
# _MEDIAPIPE_CLIP = "images_keypoints.csv"
_MEDIAPIPE_CLIP = "me 1_keypoints.csv"
# _MEDIAPIPE_CLIP = "me 2_keypoints.csv"
# _MEDIAPIPE_CLIP = "me 3_keypoints.csv"
# _MEDIAPIPE_CLIP = "me 4_keypoints.csv"
...
# _VIPE_POSE_FILE = "120-2_clip_2.npz"
# _VIPE_POSE_FILE = "120-2_clip_2_amplified.npz"
# _VIPE_POSE_FILE = "120-2_clip_3.npz"
# _VIPE_POSE_FILE = "120-2_clip_3_amplified.npz"
# _VIPE_POSE_FILE = "120-2_clip_4.npz"
# _VIPE_POSE_FILE = "120-2_clip_4_amplified.npz"
# _VIPE_POSE_FILE = "120-2_clip_5.npz"
# _VIPE_POSE_FILE = "120-2_clip_5_amplified.npz"
# _VIPE_POSE_FILE = "120-2_clip_6.npz"
# _VIPE_POSE_FILE = "120-2_clip_7.npz"
# _VIPE_POSE_FILE = "120-2_clip_7_amplified.npz"
# _VIPE_POSE_FILE = "clip_1.npz"
# _VIPE_POSE_FILE = "clip_1_amplified.npz"
# _VIPE_POSE_FILE = "clip_2.npz"
# _VIPE_POSE_FILE = "clip_2_amplified.npz"
# _VIPE_POSE_FILE = "clip_3.npz"
# _VIPE_POSE_FILE = "clip_3_amplified.npz"
# _VIPE_POSE_FILE = "clip_4.npz"
# _VIPE_POSE_FILE = "me 1.npz"
# _VIPE_POSE_FILE = "me 2.npz"
# _VIPE_POSE_FILE = "me 3.npz"
# _VIPE_POSE_FILE = "me 4.npz"

# Specific WiLoR frequency-analysis seed vertices (0-based MANO indices)
_WILOR_SPECIFIC_VERTEX_A = 333 # index finger
# _WILOR_SPECIFIC_VERTEX_A = 747 # thumb
# _WILOR_SPECIFIC_VERTEX_B = 67 #palm
_WILOR_SPECIFIC_VERTEX_B = 0 #wrist
_FACING_MODEL_VERTEX_A = 333 # index-side facing anchor
_FACING_MODEL_VERTEX_B = 173 # palm-side facing anchor

_MEDIAPIPE_POINT_COORD_A = 0 #base / wrist
_MEDIAPIPE_POINT_COORD_B = 4 #thumb i think

_MULTI_POINT_MANO_PAIRS = [
    (_WILOR_SPECIFIC_VERTEX_A, _WILOR_SPECIFIC_VERTEX_B),
    (747, 67), #thumb palm
    (333, 67), # index palm
    (444, 67), # middle palm
    (555, 67), # ring palm 
...
_MULTI_POINT_MEDIAPIPE_PAIRS = [
    (_MEDIAPIPE_POINT_COORD_A, _MEDIAPIPE_POINT_COORD_B),
    (4, 13), #thumb palm
    (8, 13), # index palm
    (12, 13), # middle palm
    (16, 13), # ring palm 
...
_STRIDE_ROOT = _OUTPUTS_ROOT / "stride" / _STRIDE_CLIP
_STRIDE_COMP = _OUTPUTS_ROOT / "stride" / _STRIDE_COMP_CLIP
_STRIDE_CAMERA_POSES = _STRIDE_ROOT / "camera_poses.npz"
...
_PATH_EXPORTS = {
    ...
    "STRIDE_ROOT": _STRIDE_ROOT,
    "STRIDE_COMP": _STRIDE_COMP,
    "STRIDE_CAMERA_POSES": _STRIDE_CAMERA_POSES,
...
_INT_EXPORTS = {
    ...
    "FACING_MODEL_VERTEX_A": _FACING_MODEL_VERTEX_A,
    "FACING_MODEL_VERTEX_B": _FACING_MODEL_VERTEX_B,
    "MEDIAPIPE_POINT_COORD_A": _MEDIAPIPE_POINT_COORD_A,
    "MEDIAPIPE_POINT_COORD_B": _MEDIAPIPE_POINT_COORD_B,
...
_RAW_EXPORTS = {
    "MULTI_POINT_MANO_PAIRS": list(_MULTI_POINT_MANO_PAIRS),
    "MULTI_POINT_MEDIAPIPE_PAIRS": list(_MULTI_POINT_MEDIAPIPE_PAIRS),
}
...
# MODEL_ROOT = STRIDE_ROOT
# MODEL_ROOT = MEDIAPIPE_ROOT

# MODEL_COMP = WILOR_ROOT
# MODEL_COMP = HAMBA_ROOT
# MODEL_COMP = DYNHAMR_ROOT
# MODEL_COMP = STRIDE_COMP
# MODEL_COMP = MEDIAPIPE_ROOT

MODEL_COMP = None 

MODEL_CAMERA_POSES = None
if MODEL_ROOT == DYNHAMR_ROOT:
    MODEL_CAMERA_POSES = DYNHAMR_CAMERA_POSES
elif MODEL_ROOT == STRIDE_ROOT:
    MODEL_CAMERA_POSES = STRIDE_CAMERA_POSES
