...
mkdir -p /scratch/mthakur/manifold/data/images/clip_3_amplified_frames

srun apptainer exec \
  --nv \
  --bind /scratch:/scratch \
  /scratch/mthakur/manifold/models/hamba/apptainer/template.sif \
  python /scratch/mthakur/manifold/models/hamba/main.py --video clip_3_amplified
