...
mkdir -p /scratch/mthakur/manifold/data/images/120-2_clip_3_frames

srun apptainer exec \
  --nv \
  --bind /scratch:/scratch \
  /scratch/mthakur/manifold/models/hamba/apptainer/template.sif \
  python /scratch/mthakur/manifold/models/hamba/main.py --video 120-2_clip_3
