...
OUTPUT_ROOT="${OUTPUT_ROOT:-${SCRIPT_DIR}/../../outputs/hamba}"
...
echo "Prepared ${video_count} hamba job scripts in ${OUT_DIR}"
echo "Submitted ${submitted_count} hamba jobs"
echo "Skipped ${skipped_count} completed hamba videos"
