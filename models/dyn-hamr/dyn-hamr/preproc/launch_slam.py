...
def get_command_list(img_dir, out_dir, start=0, end=-1, intrins_path=None, overwrite=False):
    cmd = [
        # "srun",
        sys.executable,
        f"{SRC_DIR}/run_slam.py",
        "-i", img_dir,
        "--map_dir", out_dir,
        "--disable_vis",
    ]
...
def get_command(img_dir, out_dir, start=0, end=-1, intrins_path=None, overwrite=False):
    cmd_args = [
        f"{sys.executable} {SRC_DIR}/run_slam.py",
        "-i",
        img_dir,
        "--map_dir",
        out_dir,
