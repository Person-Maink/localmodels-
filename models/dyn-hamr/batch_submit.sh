...
OUTPUT_ROOT="${OUTPUT_ROOT:-${SCRIPT_DIR}/../../outputs/dynhamr}"
...
echo "Prepared ${video_count} dyn-hamr job scripts in ${OUT_DIR}"
echo "Submitted ${submitted_count} dyn-hamr jobs"
echo "Skipped ${skipped_count} completed dyn-hamr videos"
