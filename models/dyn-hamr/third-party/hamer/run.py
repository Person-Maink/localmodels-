...
def main():
    ...
    default_det_ckpt = "https://dl.fbaipublicfiles.com/detectron2/ViTDet/COCO/cascade_mask_rcnn_vitdet_h/f328730692/model_final_f05665.pkl"
    detectron2_ckpt = os.environ.get("HAMER_DETECTRON2_CKPT", "").strip() or default_det_ckpt
    print("Using Detectron2 checkpoint:", detectron2_ckpt)
    detectron2_cfg.train.init_checkpoint = detectron2_ckpt
    for i in range(3):
