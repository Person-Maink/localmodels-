...
apptainer exec --nv \
    ...
    bash -c '/opt/conda/bin/conda run -n vipe vipe infer "/scratch/mthakur/manifold/data/images/Ipe9xJCfuTM.mp4" --output /scratch/mthakur/manifold/outputs/vipe/ --pipeline no_vda'
