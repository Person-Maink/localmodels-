...
apptainer exec --nv \
    ...
    bash -c '/opt/conda/bin/conda run -n vipe vipe infer "/scratch/mthakur/manifold/data/images/YynYZyoETto.mp4" --output /scratch/mthakur/manifold/outputs/vipe/ --pipeline no_vda'
...
#     --bind ~/.cache/huggingface:/home/mthakur/.cache/huggingface \
#     /scratch/mthakur/manifold/models/vipe/apptainer/template.sif \
#     bash -c '/opt/conda/bin/conda run -n vipe vipe infer "data/YynYZyoETto.mp4" --output /output/ --pipeline no_vda'
