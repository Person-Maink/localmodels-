...
apptainer exec --nv \
    ...
    bash -c '/opt/conda/bin/conda run -n vipe vipe infer /scratch/mthakur/manifold/data/images/clip_4.mp4 --output /scratch/mthakur/manifold/outputs/vipe/ --pipeline no_vda'
...
#     --bind ~/.cache/huggingface:/home/mthakur/.cache/huggingface \
#     /scratch/mthakur/manifold/models/vipe/apptainer/template.sif \
#     bash -c '/opt/conda/bin/conda run -n vipe vipe infer data/clip_4.mp4 --output /output/ --pipeline no_vda'
