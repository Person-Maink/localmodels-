...
apptainer exec --nv \
    ...
    bash -c '/opt/conda/bin/conda run -n vipe vipe infer /scratch/mthakur/manifold/data/images/clip_2_amplified.avi --output /scratch/mthakur/manifold/outputs/vipe/'
...
#     --bind ~/.cache/huggingface:/home/mthakur/.cache/huggingface \
#     /scratch/mthakur/manifold/models/vipe/apptainer/template.sif \
#     bash -c '/opt/conda/bin/conda run -n vipe vipe infer data/clip_2_amplified.avi --output /output/'
