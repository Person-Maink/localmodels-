...
#SBATCH --array=0-10%8
#SBATCH --output=/scratch/mthakur/manifold/models/vipe/SLURM_logs/%x_%A_%a.bootstrap.out

set -euo pipefail

MANIFEST="/scratch/mthakur/manifold/models/vipe/generated_jobs/manifests/bucket_00-30-00_20260326_113512.tsv"
...
dir="/scratch/mthakur/manifold/models/vipe/SLURM_logs"
mkdir -p "$dir"
