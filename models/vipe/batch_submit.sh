...
TEMPLATE="${TEMPLATE:-${SCRIPT_DIR}/template_vipe.sh}"
ARRAY_TEMPLATE="${ARRAY_TEMPLATE:-${SCRIPT_DIR}/template_vipe_array.sh}"
...
echo "Prepared ${video_count} vipe videos across ${submitted_arrays} array submissions"
