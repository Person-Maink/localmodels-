...
echo "Work dir:       $(pwd)"
echo "Video file:     4x8XQAPC4Vk3cugR5eQA5s.mp4"
echo "Job started at: $(date)"
start_time=$(date +%s)
echo "==============================================="

VIDEO_DIR="${VIDEO_DIR:-${PROJECT_ROOT}/data/images}"
VIDEO_NAME="${VIDEO_NAME:-4x8XQAPC4Vk3cugR5eQA5s}"
VIDEO_FILE="${VIDEO_FILE:-4x8XQAPC4Vk3cugR5eQA5s.mp4}"
