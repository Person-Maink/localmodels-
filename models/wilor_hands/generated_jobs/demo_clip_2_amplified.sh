...
mkdir -p /scratch/mthakur/manifold/data/images/clip_2_amplifiedframes

srun apptainer exec \
  --nv \
  --bind /scratch:/scratch \
  /scratch/mthakur/manifold/models/wilor_hands/apptainer/template.sif \
  python /scratch/mthakur/manifold/models/wilor_hands/main.py --video clip_2_amplified
