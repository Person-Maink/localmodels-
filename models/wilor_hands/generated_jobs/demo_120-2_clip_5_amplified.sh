...
mkdir -p /scratch/mthakur/manifold/data/images/120-2_clip_5_amplifiedframes

srun apptainer exec \
  --nv \
  --bind /scratch:/scratch \
  /scratch/mthakur/manifold/models/wilor_hands/apptainer/template.sif \
  python /scratch/mthakur/manifold/models/wilor_hands/main.py --video 120-2_clip_5_amplified
